...
GITHUB_REPOSITORY="${GITHUB_REPOSITORY:-catalystcommunity/protoc-gen-go-elasticsearch}"
DEFAULT_GITHUB_API_URL="https://api.github.com"
GITHUB_API_URL="${GITHUB_API_URL:-${DEFAULT_GITHUB_API_URL}}"

TARFILE_NAME="protoc-gen-go-elasticsearch.tar.gz"

echo ${RELEASE_NAME}

tar -cvzf "${TARFILE_NAME}" ./protoc-gen-go-elasticsearch
